...
from caen_tools.SystemCheck.scripts.structures import (
    MCHSDict, LoaderDict, InterlockParametersDict, HealthParametersDict, RelaxParamsDict,
    ReducerParametersDict, SharedParametersDict
)


def sharedmemo_fillup(manager: mp.Manager, settings: dict, section: str) -> SharedParametersDict:
