...
def run_worker(
    ...
    reducer = ReducerControl(shared_parameters["reducer"], 
        devback_address, interlockdb, mchs, relax)
    health = HealthControl(shared_parameters["health"], 
        devback_address, mon_address, mchs, max_currents, [relax, reducer])
